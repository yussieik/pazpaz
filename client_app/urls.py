...
urlpatterns = [
    ...
    path("schedule/update_treatment/<int:c_id>/<int:t_id>", views.update_treat, name='update_treatment_client'),
    path("client/update_treatment/<int:c_id>/<int:e_id>", views.update_treat, name='update_treatment_scheduler'),
