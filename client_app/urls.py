...
urlpatterns = [
    ...
    path("client/add_treatment/<int:c_id>", views.add_treatment, name='new_treatment'),
    path("client/add_treatment/<int:c_id>/<int:e_id>", views.add_treatment, name='new_treatment'),
    path("client/<int:c_id>", views.get_client, name='get_client'),
    path("search/", views.search_client, name='search_client'),
    path("client/update_client/<int:c_id>", views.update_client, name='update_client'),
    path("client/update_treatment/<int:c_id>/<int:t_id>", views.update_treat, name='update_treatment_client'),
    path("schedule/update_treatment/<int:c_id>/<int:e_id>", views.update_treat, name='update_treatment_scheduler'),
