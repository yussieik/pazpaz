...
const changeColor = props.changeType === 'increase' ? 'text-emerald-600' : 'text-red-600'
const changeIcon = props.changeType === 'increase' ? 'M5 10l7-7m0 0l7 7m-7-7v18' : 'M19 14l-7 7m0 0l-7-7m7 7V3'
</script>
