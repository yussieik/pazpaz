      ...
      >
        <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-xl" @click.stop>
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              <h2 id="cancel-dialog-title" class="text-lg font-semibold text-slate-900">
                {{ t('calendar.cancelDialog.title') }}
              </h2>
              <p class="mt-1 text-sm text-slate-600">
                {{ t('calendar.cancelDialog.description') }}
              </p>
            </div>
          </div>
          ...
          <div class="mt-4">
            ...
            >
              {{ t('calendar.cancelDialog.reasonLabel') }}
            </label>
            <textarea
              id="cancel-reason"
              v-model="cancelReason"
              rows="3"
              :placeholder="t('calendar.cancelDialog.reasonPlaceholder')"
            ...
            <p class="mt-1 text-xs text-slate-500">
              {{ t('calendar.cancelDialog.reasonHelp') }}
            </p>
          </div>
          ...
          >
            ...
            >
              {{ t('calendar.cancelDialog.keepButton') }}
            </button>
            <button
              @click="handleConfirm"
              type="button"
            ...
            >
              {{ t('calendar.cancelDialog.confirmButton') }}
            </button>
          </div>
        </div>
      </div>
