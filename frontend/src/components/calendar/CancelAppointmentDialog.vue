        ...
        <div class="w-full max-w-md rounded-xl bg-white p-6 shadow-xl" @click.stop>
          ...
          <div class="mt-4">
            ...
            <textarea
              ...
              class="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm placeholder:text-slate-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
            />
